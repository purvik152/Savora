...
export function Flag({ country, className, ...props }: FlagProps) {
  const flags: Record<string, React.ReactNode> = {
    ...
    Canada: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 600" {...props}><path fill="#ff0000" d="M0 0h1200v600H0z"/><path fill="#fff" d="M300 0h600v600H300z"/><path fill="#ff0000" d="M600 115.5l-33 88.5h-114l88.5 69-33 114 88.5-69 88.5 69-33-114 88.5-69h-114z"/></svg>
    ),
    "South Africa": (
    ...
    Hungary: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 3" {...props}><path d="M0 0h6v1H0z" fill="#ce2939"/><path d="M0 1h6v1H0z" fill="#fff"/><path d="M0 2h6v1H0z" fill="#477050"/></svg>
    ),
    Colombia: (
