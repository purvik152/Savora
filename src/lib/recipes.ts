...
export const recipes: Recipe[] = [
  ...
  // Lunch
  {
    ...
    description: 'A colorful and nutrient-packed vegetarian quinoa salad with a zesty lemon vinaigrette.',
    prepTime: '15 mins',
    cookTime: '20 mins',
    servings: '4 people',
    ingredients: [
  ...
  },
  {
    ...
    description: 'Hearty and flavorful homemade vegetarian black bean burgers that even meat-eaters will love.',
    prepTime: '20 mins',
    cookTime: '10 mins',
    servings: '4 burgers',
    ingredients: [
  ...
  },
  {
    ...
    description: 'A creamy and savory vegetarian risotto made with Arborio rice, fresh mushrooms, and Parmesan cheese. A true comfort food classic.',
    prepTime: '10 mins',
    cookTime: '30 mins',
    servings: '4 people',
    ingredients: [
  ...
  },
  {
    ...
    description: 'Colorful bell peppers filled with a delicious vegetarian mixture of spinach, feta cheese, quinoa, and herbs.',
    prepTime: '15 mins',
    cookTime: '30 mins',
    servings: '4 people',
    ingredients: [
  ...
  },
  {
    ...
    description: 'A comforting and savory vegetarian shepherd\'s pie with a rich lentil filling and a creamy mashed potato topping.',
    prepTime: '25 mins',
    cookTime: '40 mins',
    servings: '6 people',
    ingredients: [
