...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'Finish and season: Stir in the juice of half a lemon to brighten the flavors. Season generously with salt and pepper to your taste.',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Create the sauce: Deglaze the pan by pouring in 1/4 cup of dry white wine or chicken broth. Let it bubble and sizzle for about 30 seconds, scraping up any delicious browned bits from the bottom of the pan.',
  ...
  },
  {
    ...
    country: 'USA',
    diet: 'non-veg',
    image: '/images/recipes/bbq-pulled-pork.jpg',
    imageHint: 'pulled pork sandwich',
    description: 'Slow-cooked, tender, and juicy pulled pork smothered in BBQ sauce, served on a soft bun with coleslaw.',
    prepTime: '15 mins',
    cookTime: '4 hrs',
    servings: '8 people',
    ingredients: [
    ...
    instructions: [
      ...
      'Place the pork in a Dutch oven or a deep baking dish. Add about 1/2 cup of water to the bottom of the dish.',
      'Cover tightly and bake for 3.5 to 4 hours, or until the pork is fork-tender and falls apart easily.',
      'Remove the pork from the oven and let it rest for 15 minutes. Use two forks to shred the meat.',
      'In a large bowl, toss the shredded pork with the BBQ sauce until well coated.',
      'Serve the pulled pork piled high on hamburger buns, topped with coleslaw.'
    ],
    nutrition: {
      calories: '650 kcal',
      protein: '45g',
  ...
  },
  {
    ...
    imageHint: 'shakshuka pan eggs',
    description: 'A delicious and easy dish of eggs poached in a savory tomato and pepper sauce, spiced with cumin and paprika.',
    prepTime: '10 mins',
    cookTime: '20 mins',
    servings: '2-3 people',
    ingredients: [
    ...
    instructions: [
      'Heat olive oil in a large skillet over medium heat. Add the chopped onion and bell pepper and cook until soft, about 5 minutes.',
      'Stir in the garlic and cook for another minute until fragrant.',
      'Pour in the crushed tomatoes and add the paprika, cumin, and cayenne pepper. Season with salt and pepper.',
      'Bring the sauce to a simmer and let it cook for about 10 minutes to thicken slightly.',
  ...
  },
  {
    ...
    imageHint: 'korean fried chicken',
    description: 'Extra-crispy double-fried chicken wings tossed in a sweet and spicy gochujang sauce.',
    prepTime: '20 mins',
    cookTime: '25 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'Pat the chicken wings completely dry. This is key for crispy skin.',
      'In a large bowl, whisk together the cornstarch, flour, baking powder, and salt.',
      'Dredge the chicken wings in the flour mixture, shaking off any excess.',
      'Heat 2-3 inches of oil in a deep pot to 350°F (175°C). Fry the chicken in batches for 6-8 minutes until light golden. Remove and drain on a wire rack.',
      'Increase the oil temperature to 375°F (190°C). Re-fry the chicken for another 2-3 minutes until deep golden brown and extra crispy.',
      'While the chicken fries, make the sauce. In a small saucepan, combine all sauce ingredients and heat over low heat, stirring, until smooth and slightly thickened.',
      'In a large bowl, toss the hot, double-fried chicken with the sauce until evenly coated.',
  ...
  },
  {
    ...
    country: 'Brazil',
    diet: 'veg',
    image: '/images/recipes/pao-de-queijo.jpg',
    imageHint: 'cheese bread',
    description: 'A gluten-free, chewy, and cheesy bread puff that is a popular snack and breakfast food in Brazil.',
    prepTime: '10 mins',
    cookTime: '20 mins',
    servings: '12 puffs',
    ingredients: [
    ...
    instructions: [
      ...
      'In a blender, combine the egg, olive oil, and milk. Blend until smooth.',
      'Add the tapioca flour, Parmesan cheese, and salt to the blender.',
      'Blend on high for about 30 seconds, until the batter is smooth and well combined.',
      'Carefully pour the batter into the prepared mini-muffin tin, filling each cup about 3/4 full.',
      'Bake for 15-20 minutes, until the puffs are golden brown and have puffed up significantly.',
      'Let them cool for a minute in the tin before removing. Serve warm.'
    ],
    allergens: ['dairy'],
    nutrition: {
      calories: '150 kcal',
  ...
  },
  {
    ...
    imageHint: 'moussaka slice',
    description: 'A classic Greek casserole with layers of eggplant, a rich spiced meat sauce, and a creamy béchamel topping.',
    prepTime: '45 mins',
    cookTime: '1 hr',
    servings: '6-8 people',
    ingredients: [
      ...
      '1 tsp cinnamon',
      '1/4 tsp allspice',
      'For Béchamel: 4 tbsp butter, 1/2 cup flour, 4 cups milk, 2 egg yolks, pinch of nutmeg'
    ],
    instructions: [
      'Salt the eggplant slices and let them sit for 30 minutes to draw out moisture. Rinse and pat dry.',
      'Fry or bake the eggplant slices until golden. Set aside.',
      'Make the meat sauce: Sauté the onion and garlic. Add the ground meat and brown it. Stir in the spices, tomatoes, and red wine. Simmer for 20 minutes until thickened.',
      'Make the béchamel: Melt butter, whisk in flour to make a roux. Gradually whisk in warm milk until smooth. Cook until thickened. Off the heat, whisk in the egg yolks and nutmeg.',
      'Assemble: In a baking dish, layer the eggplant and meat sauce, finishing with a layer of eggplant.',
      'Pour the béchamel sauce evenly over the top.',
      'Bake at 350°F (175°C) for 45-60 minutes, until golden brown and bubbly.',
  ...
  },
  {
    ...
    imageHint: 'jerk chicken grilled',
    ...
    ingredients: [
      ...
      '2-4 Scotch bonnet peppers, stemmed',
      '1/4 cup soy sauce',
      '1/4 cup vinegar',
      '2 tbsp olive oil',
      '2 tbsp brown sugar',
    ...
    instructions: [
      'Blend all marinade ingredients in a blender until you have a relatively smooth paste.',
      'Make a few slashes in the chicken pieces and rub the marinade all over, getting it into the cuts.',
      'Cover and refrigerate for at least 4 hours, preferably overnight.',
      'Preheat your grill for indirect cooking. If using charcoal, push coals to one side. If using gas, turn off the center burners.',
      'Place the chicken on the cooler side of the grill, skin-side up. Cover and cook for 30-40 minutes.',
      'Move the chicken to the hot side of the grill to crisp up the skin, about 5 minutes per side, watching carefully to prevent burning.',
      'The chicken is done when an instant-read thermometer reads 165°F (74°C). Serve hot with rice and peas.'
    ],
    allergens: ['gluten'],
    nutrition: {
      calories: '550 kcal',
  ...
  },
  {
    ...
    country: 'Brazil',
    diet: 'non-veg',
    image: '/images/recipes/feijoada.jpg',
    imageHint: 'brazilian bean stew',
    description: 'Brazil\'s national dish, a rich and hearty black bean stew with various cuts of pork and beef.',
    ...
    ingredients: [
      ...
      '1/2 lb bacon, diced',
      '1 lb smoked sausage (like kielbasa or linguiça), sliced',
      '1 lb beef chuck, cubed',
      '2 large onions, chopped',
      '8 cloves garlic, minced',
      '2 bay leaves',
      'Orange slices, farofa (toasted manioc flour), and collard greens for serving'
    ],
    instructions: [
      'If using salted pork, soak it overnight in water, changing the water a few times to remove excess salt.',
      'In a large, heavy pot, cook the diced bacon until crispy. Remove the bacon and set aside, leaving the fat in the pot.',
      'In the same pot, brown the beef, sausage, and pork ribs in batches. Set aside.',
      'Sauté the onions and garlic in the remaining fat until softened and fragrant.',
      'Return all the meats to the pot. Add the soaked and drained black beans and the bay leaves. Add enough water to cover everything by about 2 inches.',
      'Bring to a boil, then reduce heat to a low simmer. Cover and cook for 2-3 hours, stirring occasionally, until the beans are tender and the stew has thickened.',
      'Season with salt and pepper to taste. Remove the bay leaves.',
      'Serve hot with white rice, sautéed collard greens, farofa, and fresh orange slices.'
    ],
    nutrition: {
      calories: '800 kcal',
      protein: '50g',
  ...
  },
  {
    ...
    country: 'Peru',
    diet: 'non-veg',
    image: '/images/recipes/lomo-saltado.jpg',
    imageHint: 'lomo saltado beef stir fry',
    description: 'A popular Peruvian stir-fry that combines marinated strips of sirloin with onions, tomatoes, and french fries, served with rice.',
    prepTime: '20 mins',
    cookTime: '15 mins',
    servings: '4 people',
    ingredients: [
      ...
      '1 aji amarillo (Peruvian yellow chili), seeded and sliced',
      '2 cloves garlic, minced',
      '1/4 cup chopped cilantro',
      '1 lb frozen french fries, cooked',
      'Steamed white rice for serving'
    ],
    instructions: [
      'In a bowl, marinate the steak strips with soy sauce, vinegar, and cumin for at least 15 minutes.',
      'Heat the vegetable oil in a large wok or skillet over high heat until smoking.',
      'Add the steak in a single layer and sear for 1-2 minutes without moving. Then stir-fry until just cooked through. Remove the steak from the wok.',
      'Add the onion, tomato, and aji amarillo to the wok. Stir-fry for 2-3 minutes until slightly softened but still crisp.',
      'Add the garlic and cook for 30 seconds more.',
      'Return the steak to the wok along with any accumulated juices. Add the cilantro.',
      'Toss everything together, then add the cooked french fries and toss gently to combine.',
      'Serve immediately with a side of white rice.'
    ],
    allergens: ['gluten'],
    nutrition: {
      calories: '750 kcal',
  ...
  },
  {
    id: 82,
    slug: 'bobotie',
    title: 'Bobotie (South African Spiced Meatloaf)',
    category: 'Dinner',
    cuisine: 'South African',
    country: 'South Africa',
    diet: 'non-veg',
    image: '/images/recipes/bobotie.jpg',
    imageHint: 'south african meatloaf',
    description: 'A classic South African dish consisting of spiced minced meat baked with a creamy egg-based topping.',
    prepTime: '25 mins',
    cookTime: '40 mins',
    servings: '6 people',
    ingredients: [
    ...
    instructions: [
      'Preheat oven to 350°F (175°C). Soak the bread in half of the milk.',
      'Sauté the onions in butter until soft. Add the ground meat and cook until browned.',
      'Stir in the curry powder and turmeric. Cook for a minute.',
      'Squeeze the milk from the bread (reserve the milk) and crumble the bread into the meat mixture. Add the raisins, almonds, and apricot jam. Season with salt and pepper.',
      'Transfer the mixture to a greased baking dish.',
      'For the topping, beat the remaining milk with the reserved milk from the bread and the two eggs.',
      'Pour the egg custard evenly over the meat. Garnish with bay leaves.',
  ...
  {
    id: 83,
    slug: 'tagine-with-chicken-and-apricots',
    title: 'Chicken Tagine with Apricots and Almonds',
    category: 'Dinner',
    cuisine: 'Moroccan',
    country: 'Morocco',
    diet: 'non-veg',
    image: '/images/recipes/chicken-tagine.jpg',
    imageHint: 'chicken tagine pot',
    description: 'A fragrant and savory Moroccan stew with tender chicken, sweet apricots, and crunchy almonds, slow-cooked with aromatic spices.',
    prepTime: '20 mins',
    cookTime: '1 hr 15 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      ...
      'In a large Dutch oven or tagine pot, heat the olive oil over medium-high heat. Brown the chicken on both sides. Remove and set aside.',
      'Add the sliced onions to the pot and cook until softened and golden, about 10 minutes.',
      'Stir in the garlic, ginger, and all the spices (cinnamon, cumin, turmeric, cayenne). Cook for 1 minute until fragrant.',
      ...
      'Stir in the halved apricots and continue to cook, covered, for another 15-20 minutes, until the chicken is tender.',
      'Serve the tagine over couscous, garnished with toasted almonds and fresh cilantro.'
    ],
    allergens: ['nuts'],
    nutrition: {
      calories: '700 kcal',
  ...
  },
  {
    ...
    imageHint: 'baklava dessert plate',
    ...
    instructions: [
      ...
      'Brush a 9x13 inch baking dish with melted butter. Lay a sheet of phyllo dough in the pan, and brush it with butter. Repeat for 8 sheets.',
      'Sprinkle about 1/3 of the nut mixture evenly over the top.',
      'Top with another 6 layers of buttered phyllo sheets. Sprinkle with another 1/3 of the nut mixture.',
      'Repeat with another 6 layers of buttered phyllo and the remaining nuts. Finish with a top layer of 8-10 buttered phyllo sheets.',
      'Using a very sharp knife, cut the baklava into diamond or square shapes.',
      'Bake for 45-50 minutes, until golden brown and crisp.',
      'While the baklava bakes, make the syrup. Combine water, sugar, honey, cinnamon stick, and lemon peel in a saucepan. Bring to a boil, then reduce heat and simmer for 10 minutes.',
      'As soon as the baklava comes out of the oven, pour the cooled syrup evenly over the hot pastry. Let it cool completely for several hours to absorb the syrup.'
    ],
    allergens: ['gluten', 'dairy', 'nuts'],
    nutrition: {
      calories: '300 kcal',
  ...
  {
    id: 85,
    slug: 'arepas-con-queso',
    title: 'Arepas con Queso (Cheese-stuffed Arepas)',
    category: 'Breakfast',
    cuisine: 'Colombian/Venezuelan',
    country: 'Colombia',
    diet: 'veg',
    image: '/images/recipes/arepas.jpg',
    imageHint: 'arepas cheese',
    description: 'Warm, crispy corn cakes with a gooey, melted cheese center. A staple food in Colombia and Venezuela.',
    prepTime: '15 mins',
    cookTime: '15 mins',
    servings: '6 arepas',
    ingredients: [
    ...
    instructions: [
      'In a medium bowl, combine the masarepa and salt. Gradually pour in the warm water, mixing with your hands until a soft, pliable dough forms.',
      'Knead the dough for a few minutes until smooth. Let it rest for 5 minutes.',
      'Divide the dough into 6 equal portions and roll them into balls.',
      'Press each ball between your palms to form a disc about 1/2-inch thick.',
      'Gently split each arepa open with a knife to form a pocket, or make an indentation in the center.',
      'Stuff each arepa with a generous amount of shredded mozzarella cheese and seal the edges.',
      'Heat a lightly oiled griddle or non-stick skillet over medium heat.',
      'Cook the arepas for 5-7 minutes per side, until they are golden brown and crispy on the outside and the cheese is melted on the inside.',
      'Serve hot, with a little extra butter on top if desired.'
    ],
    allergens: ['dairy'],
    nutrition: {
      calories: '350 kcal',
  ...
  },
  {
    ...
    imageHint: 'poutine fries gravy',
    description: 'The ultimate Canadian comfort food: crispy french fries topped with fresh cheese curds and smothered in a rich, brown gravy.',
    prepTime: '10 mins',
    cookTime: '20 mins',
    servings: '2-4 people',
    ingredients: [
    ...
    instructions: [
      'Fry the potatoes: Heat oil in a deep fryer or heavy pot to 300°F (150°C). Fry the potatoes for 5-6 minutes until soft but not browned. Remove and drain.',
      'Make the gravy: In a saucepan, melt the butter. Whisk in the flour and cook for 2 minutes. Gradually whisk in the beef broth until smooth. Add Worcestershire sauce and simmer for 5-10 minutes until thickened. Season with salt and pepper.',
      'Second fry: Increase the oil temperature to 375°F (190°C). Fry the potatoes again for 2-3 minutes until golden brown and crispy. Drain and salt immediately.',
      'Assemble: In a large serving bowl, place the hot fries. Scatter the cheese curds over the top.',
      'Smother: Pour the hot gravy all over the fries and cheese curds.',
      'Serve immediately, so the cheese gets soft and melty but still has a squeak.'
    ],
    allergens: ['gluten', 'dairy'],
    nutrition: {
      calories: '800 kcal',
  ...
  },
  {
    ...
    imageHint: 'korean bbq beef',
    description: 'Thinly sliced, marinated beef that is quickly cooked on a grill or in a pan. Sweet, savory, and tender.',
    prepTime: '20 mins (plus marination)',
    cookTime: '10 mins',
    servings: '4 people',
    ingredients: [
      ...
      'For the Marinade:',
      '1/2 cup soy sauce',
      '1/4 cup pear puree (or grated Asian pear)',
      '2 tbsp brown sugar',
      '2 tbsp sesame oil',
      '4 cloves garlic, minced',
      '1 tbsp minced ginger',
    ...
    instructions: [
      ...
      'Add the thinly sliced beef and toss to coat completely. Cover and refrigerate for at least 1 hour, or up to 8 hours.',
      'Heat a cast-iron skillet, grill pan, or outdoor grill over high heat.',
      'Cook the marinated beef in a single layer in batches, for 1-2 minutes per side, until cooked through and slightly caramelized.',
  ...
  },
  {
    ...
    description: 'A vibrant and healthy Korean rice bowl topped with an array of seasoned vegetables, a spicy gochujang sauce, and a fried egg.',
    prepTime: '30 mins',
    cookTime: '20 mins',
    servings: '2 people',
    ingredients: [
    ...
    instructions: [
      'Sauté each vegetable separately with a little sesame oil and a pinch of salt until tender-crisp. Set each aside.',
      'Blanch the spinach and bean sprouts in boiling water for 30 seconds. Drain, rinse with cold water, and squeeze out excess water. Season with a little soy sauce and sesame oil.',
      'In a hot skillet, fry the eggs sunny-side up.',
      'To assemble, divide the cooked rice between two large bowls.',
      'Artfully arrange the seasoned vegetables in sections on top of the rice.',
      'Place a fried egg in the center of each bowl.',
      'Serve with a dollop of gochujang. To eat, mix everything together thoroughly with a spoon or chopsticks.'
    ],
    allergens: ['gluten'],
    nutrition: {
      calories: '550 kcal',
  ...
  },
  {
    ...
    title: 'Kimchi Fried Rice (Kimchi-bokkeum-bap)',
    category: 'Dinner',
    cuisine: 'Korean',
    country: 'South Korea',
    diet: 'non-veg',
    image: '/images/recipes/kimchi-fried-rice.jpg',
    imageHint: 'kimchi fried rice',
    description: 'A simple, delicious, and deeply satisfying fried rice made with tangy, spicy kimchi, and often topped with a fried egg.',
    prepTime: '10 mins',
    cookTime: '15 mins',
    servings: '2 people',
    ingredients: [
      ...
      '4 oz bacon or spam, diced (optional)',
      '1/2 onion, chopped',
      '3 cups cooked, day-old white rice',
      '1 tbsp soy sauce',
      '1 tbsp sesame oil',
      '2 large eggs',
      'Roasted seaweed (gim) and scallions for garnish'
    ],
    instructions: [
      'Heat vegetable oil in a large skillet or wok over medium-high heat. If using, add the bacon or spam and cook until crispy.',
      'Add the chopped onion and kimchi. Sauté for 5-7 minutes, until the kimchi is softened and caramelized.',
      'Add the day-old rice to the skillet. Use a spatula to break up any clumps.',
      'Pour in the kimchi juice and soy sauce. Stir-fry for 3-5 minutes, until the rice is heated through and well-coated.',
      'Stir in the sesame oil.',
      'While the rice cooks, fry two eggs sunny-side up in a separate pan.',
      'Divide the kimchi fried rice between two bowls. Top each with a fried egg, and garnish with crumbled roasted seaweed and chopped scallions.'
    ],
    allergens: ['gluten'],
    nutrition: {
      calories: '600 kcal',
  ...
  },
  {
    ...
    imageHint: 'swedish meatballs',
    description: 'Tender, spiced meatballs served in a rich, creamy gravy. A Swedish classic made famous worldwide.',
    prepTime: '20 mins',
    cookTime: '25 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'In a bowl, mix breadcrumbs and milk and let it sit for 5 minutes.',
      'Add the ground meat, egg, grated onion, allspice, nutmeg, salt, and pepper. Mix until just combined.',
      'Roll the mixture into small, uniform meatballs.',
      'In a large skillet, brown the meatballs on all sides. Remove and set aside.',
      'In the same skillet, melt the butter for the gravy. Whisk in the flour and cook for 2 minutes.',
      'Gradually whisk in the beef broth until smooth. Bring to a simmer and cook until thickened.',
      'Stir in the heavy cream and soy sauce. Season with salt and pepper.',
      'Return the meatballs to the skillet and simmer in the gravy for 5-10 minutes.',
  ...
  },
  {
    ...
    description: 'The quintessential British takeaway meal: flaky cod in a crispy beer batter, served with thick-cut fries.',
    prepTime: '15 mins',
    cookTime: '20 mins',
    servings: '2 people',
    ingredients: [
    ...
    instructions: [
      ...
      'In a large bowl, whisk together the flour, baking powder, and salt. Gradually whisk in the cold beer until you have a smooth batter, the consistency of thin pancake batter.',
      'Pat the fish fillets completely dry. Dredge them in a little extra flour, then dip them into the beer batter, coating completely.',
      'Carefully place the battered fish into the hot oil and fry for 5-8 minutes, until golden brown and cooked through. Remove and drain on a wire rack.',
      'Fry the potatoes in batches until golden brown and cooked through.',
      'Serve the fish and chips hot, with a generous sprinkle of salt and a side of malt vinegar and tartar sauce.'
    ],
    allergens: ['gluten'],
    nutrition: {
      calories: '900 kcal',
  ...
  },
  {
    ...
    imageHint: 'eton mess dessert',
    description: 'A classic British dessert made from a mixture of broken meringue, strawberries, and whipped cream.',
    prepTime: '15 mins',
    cookTime: '0 mins',
    servings: '4 people',
    ingredients: [
      ...
      '2 cups heavy cream',
      '1 tsp vanilla extract',
      '4 large meringue nests, store-bought or homemade, broken into chunks'
    ],
    instructions: [
      'In a bowl, toss the sliced strawberries with the sugar and let them sit for 10 minutes to release their juices.',
      'In a separate large bowl, whip the heavy cream and vanilla extract until soft peaks form.',
      'Gently fold the broken meringue chunks and most of the strawberries (reserving some for garnish) into the whipped cream.',
      'Do not overmix; you want to see streaks of strawberry and chunks of meringue.',
      'Spoon the mixture into individual serving glasses or bowls.',
      'Top with the reserved strawberries and serve immediately.'
    ],
    allergens: ['dairy'],
    nutrition: {
      calories: '450 kcal',
  ...
  },
  {
    ...
    country: 'Mexico',
    diet: 'veg',
    image: '/images/recipes/tres-leches-cake.jpg',
    imageHint: 'tres leches cake slice',
    description: 'A light and fluffy sponge cake soaked in three kinds of milk: evaporated milk, condensed milk, and heavy cream.',
    prepTime: '25 mins',
    cookTime: '30 mins',
    servings: '12 people',
    ingredients: [
    ...
    instructions: [
      ...
      'In a large bowl, beat the egg yolks with 3/4 cup of sugar until light and pale. Stir in the milk and vanilla.',
      ...
      'Gently fold the egg yolk mixture into the egg whites. Then, gradually fold in the flour mixture.',
      'Pour the batter into the prepared pan and bake for 25-30 minutes, until a toothpick inserted comes out clean.',
      'Let the cake cool. While it cools, combine the evaporated milk, condensed milk, and heavy cream in a bowl.',
      'Once the cake is cool, poke holes all over the top with a fork. Slowly pour the three-milk mixture over the cake, allowing it to soak in.',
      'Refrigerate for at least 1 hour. Serve chilled, topped with whipped cream and a cherry.'
    ],
    allergens: ['gluten', 'dairy'],
    nutrition: {
      calories: '400 kcal',
  ...
  },
  {
    ...
    country: 'Spain',
    diet: 'veg',
    image: '/images/recipes/churros-chocolate.jpg',
    imageHint: 'churros chocolate',
    description: 'Crispy, fried dough pastries dusted with cinnamon sugar, served with a thick, rich chocolate dipping sauce.',
    prepTime: '20 mins',
    cookTime: '20 mins',
    servings: '4 people',
    ingredients: [
      ...
      'For chocolate sauce: 1 cup heavy cream, 4 oz bittersweet chocolate'
    ],
    instructions: [
      'Make the dough: In a saucepan, bring water, butter, and salt to a boil. Reduce heat to low and add all the flour at once. Stir vigorously with a wooden spoon until the mixture forms a ball.',
      'Remove from heat and let it cool for 5 minutes. Beat in the eggs one at a time until the dough is smooth.',
      'Heat oil for frying to 360°F (180°C).',
      'Transfer the dough to a piping bag fitted with a large star tip. Pipe 4-6 inch lengths of dough directly into the hot oil.',
      ...
      'Make the sauce: Heat heavy cream until just simmering. Pour over chopped chocolate and let it sit for a minute, then stir until smooth.',
  ...
  },
  {
    ...
    country: 'Thailand',
    diet: 'veg',
    image: '/images/recipes/mango-sticky-rice.jpg',
    imageHint: 'mango sticky rice',
    description: 'A classic Thai dessert of sweet, sticky rice steamed with coconut milk, served with fresh, ripe mango.',
    ...
    instructions: [
      'Drain the soaked sticky rice. Steam it for 20-25 minutes until tender and cooked through.',
      'While the rice steams, make the coconut sauce. In a saucepan, heat 1 cup of coconut milk, 1/2 cup of sugar, and the salt over medium heat. Stir until the sugar dissolves. Do not boil.',
      'Once the rice is cooked, transfer it to a bowl. Pour the hot coconut sauce over the rice and stir to combine. Cover and let it sit for 20 minutes to absorb the sauce.',
      'Make the topping: In the same saucepan, heat the remaining coconut milk with the remaining 1/2 cup of sugar. Simmer until it thickens slightly.',
      'To serve, place a portion of the sweet sticky rice onto a plate. Arrange fresh mango slices alongside.',
      'Drizzle with the thickened coconut cream topping and sprinkle with toasted sesame seeds.'
    ],
    nutrition: {
      calories: '550 kcal',
      protein: '6g',
  ...
  },
  {
    ...
    imageHint: 'alfajores cookies',
    description: 'Tender, crumbly shortbread-like cookies filled with creamy dulce de leche and rolled in coconut.',
    prepTime: '30 mins',
    cookTime: '12 mins',
    servings: '18 cookies',
    ingredients: [
    ...
    instructions: [
      'Preheat oven to 350°F (175°C).',
      'In a bowl, whisk together the cornstarch, flour, baking soda, and baking powder.',
      'In a separate large bowl, cream the butter and sugar until light and fluffy. Beat in the egg yolks and vanilla.',
      'Gradually add the dry ingredients to the wet ingredients, mixing until a soft dough forms.',
      'On a lightly floured surface, roll the dough out to 1/4-inch thickness. Cut out circles using a 2-inch cookie cutter.',
      'Place the cookies on a parchment-lined baking sheet and bake for 10-12 minutes, until the edges are lightly golden. Do not let them brown.',
      'Let the cookies cool completely on a wire rack.',
      'To assemble, spread a generous layer of dulce de leche on the flat side of one cookie and top with another cookie to make a sandwich.',
      'Gently roll the edges of the sandwich in shredded coconut.',
      'Let them sit for a few hours for the best texture.'
    ],
    allergens: ['gluten', 'dairy'],
    nutrition: {
      calories: '200 kcal',
  ...
  },
  {
    ...
    imageHint: 'pierogi plate',
    description: 'Classic Polish dumplings filled with a savory mixture of mashed potatoes and cheese, boiled and then pan-fried.',
    prepTime: '1 hr',
    cookTime: '20 mins',
    servings: '4-6 people',
    ingredients: [
      ...
      'Butter and chopped onions for serving'
    ],
    instructions: [
      'Make the dough: In a bowl, mix flour and salt. Make a well in the center and add the egg and warm water. Mix until a dough forms, then knead on a floured surface for 5-7 minutes until smooth. Cover and let it rest for 30 minutes.',
      'Make the filling: In a bowl, combine the hot mashed potatoes, cheese, and sautéed onions. Season well with salt and pepper.',
      'Roll out the dough thinly and cut out circles using a glass or cookie cutter.',
      'Place a spoonful of filling on one half of each circle. Fold the other half over and press the edges firmly to seal, creating a half-moon shape.',
      'Bring a large pot of salted water to a boil. Cook the pierogi in batches for 3-5 minutes, or until they float to the top.',
      'Remove with a slotted spoon.',
      'For best results, pan-fry the boiled pierogi in butter with some chopped onions until golden brown.',
  ...
  },
  {
    ...
    imageHint: 'goulash stew bowl',
    description: 'A rich and hearty Hungarian stew of beef and vegetables, seasoned generously with paprika.',
    prepTime: '20 mins',
    cookTime: '2 hrs',
    servings: '6 people',
    ingredients: [
    ...
    instructions: [
      'In a large Dutch oven or pot, heat the oil over medium heat. Add the onions and cook until soft and translucent, about 10 minutes.',
      'Remove the pot from the heat and stir in the paprika, caraway seeds, and garlic. This prevents the paprika from burning.',
      'Return to the heat, add the beef cubes, and cook until browned on all sides.',
      'Stir in the diced tomatoes and beef broth. Bring to a simmer.',
      'Reduce the heat to low, cover, and cook for at least 1.5 hours, until the beef is starting to become tender.',
      'Add the carrots and potatoes to the pot. Cover and continue to simmer for another 30-45 minutes, until the vegetables and beef are tender.',
      'Season with salt and pepper to taste. Serve hot, often with a dollop of sour cream.'
    ],
    allergens: [],
    nutrition: {
      calories: '550 kcal',
