...
export const recipes: Recipe[] = [
  ...
  {
    id: 59,
    slug: 'bacon-egg-breakfast-tacos',
    title: 'Bacon & Egg Breakfast Tacos',
    category: 'Breakfast',
    cuisine: 'Tex-Mex',
    country: 'Mexico',
    diet: 'non-veg',
    image: '/images/recipes/bacon-egg-breakfast-tacos.jpg',
    imageHint: 'breakfast tacos',
    description: 'A delicious and satisfying start to your day, combining crispy bacon, fluffy eggs, and your favorite toppings in a warm tortilla.',
    prepTime: '5 mins',
    cookTime: '10 mins',
    servings: '2 people',
    ingredients: [
    ...
    instructions: [
      'Cook the bacon in a skillet until crispy. Remove from the pan, drain on paper towels, and crumble once cooled. Scramble the eggs in the same skillet with a little of the bacon grease for extra flavor.',
      'Warm the tortillas in a dry skillet or in the microwave for about 20-30 seconds until soft and pliable.',
      'Assemble the tacos by dividing the scrambled eggs among the warm tortillas.',
      'Top with crumbled bacon and shredded cheese.',
      'Add any optional toppings like salsa, sliced avocado, or fresh cilantro. Serve immediately.'
    ],
    allergens: ['dairy'],
    nutrition: {
      calories: '480 kcal',
  ...
  {
    id: 60,
    slug: 'classic-smoked-salmon-bagel',
    title: 'Classic Smoked Salmon Bagel',
    category: 'Breakfast',
    cuisine: 'American',
    country: 'USA',
    diet: 'non-veg',
    image: '/images/recipes/classic-smoked-salmon-bagel.jpg',
    imageHint: 'salmon bagel',
    description: 'An iconic and elegant breakfast featuring a toasted bagel with cream cheese, smoked salmon, and classic toppings.',
    prepTime: '10 mins',
    cookTime: '5 mins',
    servings: '1 person',
    ingredients: [
    ...
    instructions: [
      'Toast the bagel to your desired level of crispness.',
      'Spread a generous layer of softened cream cheese on both halves of the toasted bagel.',
      'Drape the slices of smoked salmon over the cream cheese.',
      'Sprinkle the capers evenly over the salmon.',
      'Arrange a few thin slices of red onion on top.',
      'Garnish with fresh dill sprigs and serve open-faced or as a sandwich. Enjoy immediately.'
    ],
    allergens: ['gluten', 'dairy'],
    nutrition: {
      calories: '450 kcal',
  ...
  {
    id: 65,
    slug: 'dosa-with-sambar-and-chutney',
    title: 'Dosa with Sambar and Chutney',
    category: 'Breakfast',
    cuisine: 'South Indian',
    country: 'India',
    diet: 'veg',
    image: '/images/recipes/dosa-sambar-chutney.jpg',
    imageHint: 'dosa breakfast',
    description: 'A classic South Indian breakfast featuring a crispy fermented crepe (dosa) served with a flavorful lentil-vegetable stew (sambar) and coconut chutney.',
    prepTime: '20 mins (plus fermentation time)',
    cookTime: '30 mins',
    servings: '4 people',
    ingredients: [
      'For Dosa Batter:',
      ...
      '2 cups mixed vegetables (carrots, drumsticks, pumpkin)',
    ...
    instructions: [
      'Make Dosa Batter: Soak rice and dal separately for 4-6 hours. Grind to a smooth batter. Mix, add salt, and let it ferment overnight.',
      'Make Sambar: Cook toor dal until soft. In a separate pot, cook vegetables. Mix cooked dal, vegetables, tamarind water, and sambar powder. Simmer for 15-20 minutes.',
      'Make Chutney: Grind coconut, green chilies, and ginger with a little water to a smooth paste. Temper with mustard seeds and curry leaves.',
      'Make Dosas: Heat a non-stick tawa or griddle. Pour a ladleful of batter in the center and spread it in a circular motion to make a thin crepe. Drizzle with oil and cook until golden brown and crispy.',
      'Serve: Serve hot dosas immediately with sambar and coconut chutney.'
    ],
    allergens: [],
    nutrition: {
      calories: '400 kcal',
  ...
  },
  {
    ...
    imageHint: 'vada pav street food',
    description: 'The quintessential Mumbai street food, a spiced potato fritter (vada) tucked inside a soft bread roll (pav), layered with chutneys.',
    prepTime: '30 mins',
    cookTime: '20 mins',
    servings: '4 people',
    ingredients: [
      ...
      '8 pav (bread rolls)',
      'Dry garlic chutney and green chutney for serving'
    ],
    instructions: [
      'Make Potato Filling: Heat oil, add mustard seeds, asafoetida, ginger-garlic paste, and chilies. Sauté for a minute. Add turmeric and the mashed potatoes. Mix well and let it cool.',
      'Shape Vadas: Make small balls from the potato mixture.',
      'Make Batter: Mix gram flour with water, salt, and a pinch of turmeric to form a thick batter.',
      'Fry Vadas: Dip each potato ball in the batter and deep-fry in hot oil until golden brown.',
      'Assemble Vada Pav: Slit a pav horizontally, spread green chutney and dry garlic chutney inside. Place a hot vada in the center.',
      'Serve: Serve immediately, sometimes with fried green chilies on the side.'
    ],
    allergens: ['gluten'],
    nutrition: {
      calories: '350 kcal',
  ...
  },
  {
    ...
    imageHint: 'paella pan',
    description: 'The authentic Spanish paella with chicken, rabbit, and beans, cooked in a wide, shallow pan to create the perfect "socarrat".',
    prepTime: '30 mins',
    cookTime: '50 mins',
    servings: '6 people',
    ingredients: [
    ...
    instructions: [
      ...
      'Add the chicken and rabbit pieces, seasoned with salt. Sauté until golden brown on all sides.',
      'Add the green beans and lima beans, and sauté for a few minutes.',
      'Stir in the grated tomato and paprika, cooking for a minute until fragrant.',
      'Add the water or broth and saffron threads. Bring to a vigorous boil and cook for about 10-15 minutes.',
      'Sprinkle the rice evenly across the pan. Add the rosemary sprig. Do not stir the rice from this point on.',
      'Cook for about 18-20 minutes, reducing the heat as the liquid is absorbed. The goal is to have a dry paella with a crispy, caramelized bottom layer called "socarrat".',
      'Remove from heat, cover with a clean cloth, and let it rest for 5-10 minutes before serving.'
    ],
    nutrition: {
      calories: '650 kcal',
      protein: '40g',
  ...
  {
    id: 62,
    slug: 'sushi-maki-rolls',
    title: 'Sushi Maki Rolls',
    category: 'Dinner',
    cuisine: 'Sushi',
    country: 'Japan',
    diet: 'non-veg',
    image: '/images/recipes/sushi-maki-rolls.jpg',
    imageHint: 'sushi rolls',
    description: 'Learn to make classic Japanese maki rolls at home with your favorite fillings.',
    prepTime: '45 mins',
    cookTime: '20 mins',
    servings: '4 rolls',
    ingredients: [
      ...
      'Fillings: sushi-grade tuna or salmon, avocado, cucumber',
      'Soy sauce, wasabi, and pickled ginger for serving',
      'Bamboo rolling mat'
    ],
    instructions: [
      'Place a sheet of nori, shiny side down, on the bamboo rolling mat.',
      'Wet your hands in water to prevent sticking, and spread a thin, even layer of sushi rice over the nori, leaving a 1-inch border at the top.',
      'Arrange your chosen fillings in a line across the center of the rice.',
      'Begin rolling from the bottom edge, using the mat to tuck in the fillings and create a tight cylinder.',
  ...
  },
  {
    ...
    description: 'A rich and creamy pork bone broth ramen, topped with tender chashu pork, a soft-boiled egg, and other classic toppings.',
    prepTime: '30 mins',
    cookTime: '12 hrs (for broth)',
    servings: '4 people',
    ingredients: [
      '4 lbs pork bones (femur, neck)',
      '1 lb pork belly for chashu',
      '4 servings fresh ramen noodles',
      '4 soft-boiled eggs (Ajitsuke Tamago)',
      'Toppings: sliced scallions, menma (bamboo shoots), nori',
      'Aromatics: ginger, garlic, onion'
    ],
    instructions: [
      'Make the broth: Blanch the pork bones in boiling water for 10 minutes to remove impurities. Drain and rinse.',
      'Return the bones to a large stockpot, cover with water, and bring to a rolling boil. Continue to boil vigorously for 8-12 hours, adding water as needed, until the broth is opaque, white, and creamy.',
      'Make the chashu pork: Roll the pork belly and tie it with kitchen twine. Sear all sides in a pan. Then simmer in a mixture of soy sauce, mirin, sake, and sugar for 2 hours until tender.',
      'Cook the noodles: Cook the fresh ramen noodles according to package directions until al dente.',
      'Assemble the bowl: Add tare (seasoning base) to each bowl. Pour in the hot tonkotsu broth. Add the cooked noodles.',
      'Top with sliced chashu pork, a halved soft-boiled egg, scallions, menma, and a sheet of nori.',
      'Serve immediately.'
    ],
    allergens: ['gluten'],
    nutrition: {
  ...
  },
  {
    ...
    imageHint: 'mapo tofu bowl',
    description: 'A classic Sichuan dish with soft tofu set in a spicy, numbing, and savory sauce with ground pork.',
    prepTime: '15 mins',
    cookTime: '15 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'Gently simmer the tofu cubes in salted water for a minute to firm them up. Drain and set aside.',
      'Heat oil in a wok or large skillet. Add the ground pork and stir-fry until cooked through and crispy.',
      'Add the doubanjiang and fermented black beans. Stir-fry for a minute until the oil is red and fragrant.',
      'Add the garlic and ginger and stir-fry for 30 seconds.',
      'Pour in the chicken broth and bring to a simmer. Season with ground Sichuan peppercorns.',
      'Gently add the tofu cubes. Simmer for 3-5 minutes.',
      'Thicken the sauce with the cornstarch slurry, stirring gently.',
      'Serve hot over rice, garnished with more Sichuan pepper and sliced scallions.'
    ],
    nutrition: {
      calories: '450 kcal',
      protein: '25g',
  ...
  },
  {
    ...
    imageHint: 'dal makhani bowl',
    description: 'A rich and creamy lentil curry made with whole black lentils and kidney beans, slow-cooked in a tomato-based sauce with butter and cream.',
    ...
    instructions: [
      'Soak lentils and beans overnight. Drain and pressure cook until very tender.',
      'Heat butter in a pan, sauté onions until golden. Add ginger-garlic paste and sauté for a minute.',
      'Add tomato puree and cook until oil separates. Add chili powder and salt.',
      'Pour this tempering over the cooked lentils. Add water if needed. Simmer for at least 30 minutes.',
      'Add garam masala and heavy cream. Simmer for another 5 minutes.',
  ...
  },
  {
    ...
    imageHint: 'aloo gobi dish',
    description: 'A classic and comforting North Indian dry curry made with potatoes (aloo) and cauliflower (gobi) sautéed with onions, tomatoes, and spices.',
    prepTime: '15 mins',
    cookTime: '25 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'Heat oil in a pan, add cumin seeds. Once they splutter, add the onions and sauté until translucent.',
      'Add potatoes and cauliflower. Sauté for 5-7 minutes.',
      'Add chopped tomatoes, turmeric, coriander powder, and salt. Mix well.',
      'Cover and cook on low heat for 15-20 minutes, or until the vegetables are tender, stirring occasionally.',
      'Sprinkle with garam masala and garnish with fresh cilantro.',
  ...
  },
  {
    ...
    instructions: [
      'Make Chole: Pressure cook the soaked chickpeas until tender. In a pan, sauté onions, add tomato puree and chole masala. Cook until oil separates. Add the cooked chickpeas and simmer.',
      'Make Bhature Dough: Knead a soft dough with flour, yogurt, baking soda, salt, and water. Let it rest for 2-3 hours.',
      'Fry Bhature: Roll out small discs from the dough and deep-fry in hot oil until they puff up and turn golden brown.',
      'Serve: Serve hot bhature with the prepared chole, garnished with sliced onions and a lemon wedge.'
    ],
    allergens: ['gluten', 'dairy'],
    nutrition: {
      calories: '600 kcal',
  ...
  },
  {
    ...
    imageHint: 'palak paneer bowl',
    description: 'A popular North Indian vegetarian curry made with spinach (palak) and Indian cottage cheese (paneer) in a creamy, spiced gravy.',
    prepTime: '20 mins',
    cookTime: '25 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'Blanch spinach in hot water, then plunge into cold water. Blend to a smooth puree.',
      'Heat oil in a pan, sauté onions until golden. Add ginger-garlic paste and cook for a minute.',
      'Add tomato puree and cook until oil separates. Add cumin powder and salt.',
      'Stir in the spinach puree and cook for 5-7 minutes.',
      'Add paneer cubes and garam masala. Simmer for a few minutes.',
  ...
  },
  {
    ...
    imageHint: 'vegetable biryani pot',
    description: 'A fragrant and flavorful one-pot rice dish made with basmati rice, mixed vegetables, and a blend of aromatic spices.',
    prepTime: '30 mins',
    cookTime: '45 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'Cook basmati rice until 70% done and drain.',
      'Marinate vegetables with yogurt, ginger-garlic paste, biryani masala, and salt.',
      'In a heavy-bottomed pot, layer the marinated vegetables and the partially cooked rice.',
      'Top with fried onions, saffron milk, and a drizzle of ghee.',
      'Cover and cook on low heat (dum) for 20-25 minutes until the rice is fully cooked and aromatic.',
  ...
  {
    id: 72,
    slug: 'masoor-dal-tadka',
    title: 'Masoor Dal Tadka',
    category: 'Dinner',
    cuisine: 'North Indian',
    country: 'India',
    diet: 'veg',
    image: '/images/recipes/masoor-dal-tadka.jpg',
    imageHint: 'dal tadka bowl',
    description: 'A simple and nutritious red lentil curry, tempered with aromatic spices in ghee or oil (tadka).',
    prepTime: '10 mins',
    cookTime: '20 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'Pressure cook the masoor dal with turmeric and salt until soft and mushy.',
      'For the tadka, heat ghee in a small pan. Add cumin seeds, asafoetida, and dried red chili.',
      'Once the seeds crackle, add the chopped onion and garlic. Sauté until golden brown.',
  ...
  },
  {
    ...
    imageHint: 'rajma chawal bowl',
    description: 'A beloved North Indian comfort food combo of red kidney bean curry (rajma) served with steamed rice (chawal).',
    prepTime: '15 mins (plus soaking time)',
    cookTime: '45 mins',
    servings: '4 people',
    ingredients: [
    ...
    instructions: [
      'Pressure cook the soaked rajma with salt until very tender.',
      'Heat oil in a pan, add onion puree and sauté until brown. Add ginger-garlic paste and cook.',
      'Add tomato puree, cumin, coriander, and salt. Cook until oil separates from the masala.',
      'Add the cooked rajma along with its water. Mash some beans to thicken the gravy.',
      'Simmer for 15-20 minutes. Add garam masala and cook for a few more minutes.',
